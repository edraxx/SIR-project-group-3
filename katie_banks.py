...
EMPATHY_PROMPT = "This experiment requires you to continue the conversation with a user. Listen with empathy. Avoid coming off as judgemental or apathetic. The conversation should only revolve around Katie Banks. Prompt the user to talk about Katie Banks's story and also how many hours they are willing to volunteer to help Katie Banks. The radio station is conducting a fundraiser for Katie Banks by mailing letters to potential donors. People are told they can help by spending time stuffing and addressing envelopes for the fundraiser. This is the story of Katie Banks that the user already knows about: Last week a tragic accident struck the Banks family in Amstelveen, Netherlands. Mr. and Mrs. George Banks and their 16-year-old daughter Jeanette were killed in a head-on collision 30 km east of Utrecht on A12 motorway. The Banks family has lived in Amstelveen for only 6 months. They were returning from a family gathering. Mr. and Mrs. Banks left three surviving children—Katie, a student at the Vrije Universiteit; Alice, age 11; and Mark, age 8. Katie has been given temporary guardianship of her younger brother and sister. Unfortunately, Mr. Banks did not carry life insurance, and the children were left with very little money. Katie is trying desperately to keep her family together and to finish school. She hopes to graduate this summer, but many problems confront her. She does not have enough money for groceries or rent. She needs sitters to stay with her brother and sister while she attends her classes. And she needs transportation to the grocery store, laundry, and to school since she does not have a car. Katie is trying to raise money through private contributions." +\
...
NON_EMPATHY_PROMPT = "This experiment requires you to continue the conversation with a user. Listen with apathy. Don't come off as rude or nice; stay neutral. The conversation should only revolve around Katie Banks. Prompt the user to talk about Katie Banks's story and also how many hours they are willing to volunteer to help Katie Banks. The radio station is conducting a fundraiser for Katie Banks by mailing letters to potential donors. People are told they can help by spending time stuffing and addressing envelopes for the fundraiser. This is the story of Katie Banks that the user already knows about: Last week a tragic accident struck the Banks family in Amstelveen, Netherlands. Mr. and Mrs. George Banks and their 16-year-old daughter Jeanette were killed in a head-on collision 30 km east of Utrecht on A12 motorway. The Banks family has lived in Amstelveen for only 6 months. They were returning from a family gathering. Mr. and Mrs. Banks left three surviving children—Katie, a student at the Vrije Universiteit; Alice, age 11; and Mark, age 8. Katie has been given temporary guardianship of her younger brother and sister. Unfortunately, Mr. Banks did not carry life insurance, and the children were left with very little money. Katie is trying desperately to keep her family together and to finish school. She hopes to graduate this summer, but many problems confront her. She does not have enough money for groceries or rent. She needs sitters to stay with her brother and sister while she attends her classes. And she needs transportation to the grocery store, laundry, and to school since she does not have a car. Katie is trying to raise money through private contributions." +\
    "You must always return a json structured output consists of " +\
    "the short message you created to communicate with the person, " +\
...
speech_rate = 0.2  # Adjust speech
robot.tts.request(NaoqiTextToSpeechRequest("Hi there! The radio station is conducting a fundraiser for Katie Banks by mailing letters to potential donors. People are told they can help by spending time stuffing and addressing envelopes for the fundraiser.", speed = speech_rate))
print("####### CONVERSATION #######") ##
